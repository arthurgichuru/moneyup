...
import 'package:moneyup/presentation/edit_profile_screen/models/edit_profile_model.dart';
...
class EditProfileController extends GetxController {
  ...
  void _handleFetchMeSuccess() {
    phoneController.text = getMeResp.data!.username!.toString();
    emailController.text = getMeResp.data!.email!.toString();
    nameController.text = getMeResp.data!.name!.toString();
  }
